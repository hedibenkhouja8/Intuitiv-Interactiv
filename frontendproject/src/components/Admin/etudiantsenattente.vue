                                       ...
                                       <table class="table table-striped">
                                          ...
                                          <tbody>
                                             <tr v-bind:key="item.id" v-for="item in info">
                                                  <td> <img v-bind:src="'http://localhost:8000/storage/files/register/profilepic/'+item.profilepic"   class="xx"  alt="non disponible"></td>
                                                <td>{{ item.name }}</td>
                                                
                                                <td>{{ item.prenom }}</td>
                                                  <td>{{ item.email }}</td>
                                                <td>{{ item.etablisement.nom }}</td>
                                                <td><button class="btn btn-info"><i class="fa fa-search"></i></button></td>
                                                
                                                <td><button class="btn btn-success">Accepter</button>&nbsp;&nbsp;<button class="btn btn-danger">Refuser</button></td>
                                             </tr>
