 ...
 */
final class Version20220330141912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demandeempreint (id INT AUTO_INCREMENT NOT NULL, memoire_id INT DEFAULT NULL, datedebut DATETIME NOT NULL, datefin DATETIME NOT NULL, INDEX IDX_3C2FBCBDDE665C15 (memoire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE memoire CHANGE titre titre VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
