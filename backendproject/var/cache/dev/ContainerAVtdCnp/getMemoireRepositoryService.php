 ...
 */
class getMemoireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MemoireRepository' shared autowired service.
     *
     * @return \App\Repository\MemoireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MemoireRepository.php';

        return $container->privates['App\\Repository\\MemoireRepository'] = new \App\Repository\MemoireRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
