 ...
 */
class getDemandeempreintRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DemandeempreintRepository' shared autowired service.
     *
     * @return \App\Repository\DemandeempreintRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DemandeempreintRepository.php';

        return $container->privates['App\\Repository\\DemandeempreintRepository'] = new \App\Repository\DemandeempreintRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
